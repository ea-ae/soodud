...
def test_text_preparation():
    ...
    text = '- 3 km JÄÄTIS, ja coop! 3,5  % 3 * 0,5l kg. % plus+ l! 7 tk leib- tk sai a b c g 4 km 2 %vol 2%vol'
    expected_text = '3km jaatis 3.5% 3x0.5l 1kg plus 1l 7tk leib tk sai 1g 4km 2% vol 2% vol'
